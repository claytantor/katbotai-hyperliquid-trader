...
def print_env_instructions(wallet_private_key_placeholder: str, agent_private_key: str):
    print()
    print(bold("══════════════════════════════════════════"))
    print(bold(" Add these to your ~/.bashrc or ~/.zshrc:"))
    print(bold("══════════════════════════════════════════"))
    print()
    print(yellow("  # Katbot.ai — wallet key (required for re-auth)"))
    print(yellow(f"  export WALLET_PRIVATE_KEY=0xYourMetaMaskPrivateKey"))
    print()
    print(yellow("  # Katbot.ai — agent key (stored locally, also set here for portability)"))
    print(yellow(f"  export KATBOT_HL_AGENT_PRIVATE_KEY={agent_private_key}"))
    print()
    print("  ⚠️  Replace 0xYourMetaMaskPrivateKey with your actual wallet key.")
